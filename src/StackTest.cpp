...
//This is StackTest.cpp

- Test default constructor by create an empty stack.
Default constructor works
- Test empty() on the empty stack. Should print out: 'Yes. The stack is empty'
Yes. The stack is empty
- Test getSize(). Should get 0
0
- Test print. Should get empty line

- Now, push 1 2 3 4, then empty(). Should print out: 'No. The stack is not empty'
No. The stack is not empty
- Test getSize() again. Should get 4
4
- Test print. Should get 4 3 2 1
4 3 2 1
- Now, test pop 1 node. Then getSize(). Should get 3
3
- Test print. Should get 3 2 1
3 2 1
- Now, create 2 empty Stacks and test ==. Should print 'Equal'
Equal
-Now, push 1 2 3 to one of them and test ==. Should print 'Not equal'
Not Equal
- Now test == between the 2 Stacks with 3 2 1. Should print 'Equal'
Equal
- Now, test copy constructor. Create S4 as acopy of S1. then print S4. Should get 3 2 1
3 2 1
